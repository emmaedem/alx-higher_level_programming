...
In a nutshell…
Auto QA review: 84.35/160 mandatory & 9.0/41 optional
Altogether:  64.29%
Mandatory: 52.72%
Optional: 21.95%
Calculation:  52.72% + (52.72% * 21.95%)  == 64.29%
...
1. The last digit
mandatory
Score: 64.67% (Checks completed: 100.0%)
...
7. islower
mandatory
Score: 64.12% (Checks completed: 100.0%)
...
#advanced
Score: 46.43% (Checks completed: 92.86%)
